                        ...
                        <div class="card-header row">
                            <div class="col-md-10 d-flex mt-2">
                                <div class="preview d-flex">
                                    ...
                                    <div class="icon-class" style="font-size: 25px;">Index of Colors</div>
                                </div>
                            </div>
                            <div class="pull-right">
                                <a class="btn btn-icon icon-left btn-warning"
                                    href="{{ route('admin.color.create') }}"><i class="fas fa-plus-circle"></i>Create
                                    An color</a>
                            </div>
                        </div>
                        <div class="card-body">
                                                ...
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item has-icon"
                                                            href="{{ route('admin.color.show',$item->id) }}"><i
                                                                class="far fa-eye"></i> View</a>
                                                        <a class="dropdown-item has-icon"
                                                            href="{{ route('admin.color.edit',$item->id) }}"><i
