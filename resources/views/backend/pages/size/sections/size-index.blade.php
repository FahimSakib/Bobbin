                                                ...
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item has-icon"
                                                            href="{{ route('admin.size.show',$item->id) }}"><i
                                                                class="far fa-eye"></i>   View</a>
                                                        <a class="dropdown-item has-icon"
                                                            href="{{ route('admin.size.edit',$item->id) }}"><i
                                                            ...
                                                            <i class="fas fa-trash-alt"></i> <button type="submit"
                                                                class="btn" aria-hidden="true"  style="background-size:transparent; margin-right:50px;">Delete</button>
                                                        </form>
                                                       </div>
