                        ...
                        <div class="card-header row">
                            <div class="col-md-10 d-flex mt-2">
                                <div class="preview d-flex">
                                    ...
                                    <div class="icon-class" style="font-size: 25px;">Index of Categories</div>
                                </div>
                            </div>
                            <div class="pull-right">
                                <a class="btn btn-icon icon-left btn-warning"
                                    href="{{ route('admin.category.create') }}"><i class="fas fa-plus-circle"></i>Create
                                    An category</a>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="alert alert-info alert-has-icon col-md-9">
                                    ...
                                    <div class="alert-body">
                                        ...
                                        <h5>
                                            There is no Category available! please create a new Category to show in the
                                            list.
                                        </h5>
                                    </div>
                                </div>
