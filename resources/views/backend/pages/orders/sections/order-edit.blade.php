                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text"
                                                ...
                                                name="short_description" value="{{$order->short_description}}">
                                        ...
                                        <div class="alert alert-light alert-has-icon col-md-12 dash-border">
                                            ...
                                            <div class="alert-body">
                                                ...
                                                If you want to change or update the images of the current order, then
                                                upload the new ones; <br> otherwise, keep the image field blank. See the
                                                gallery for current order images.
                                            </div>
                                            <div class="col-md-4">
                                                <div class="gallery mt-3">
                                                    <div class="gallery-item"
                                                        data-image="{{ asset('storage/Product_Image/'.$order->image1) }}"
                                                        data-title="Image 1">
                                                    </div>
                                                    <div class="gallery-item"
                                                        data-image="{{ asset('storage/Product_Image/'.$order->image2) }}"
                                                        data-title="Image 2">
                                                    </div>
                                                    <div class="gallery-item"
                                                        data-image="{{ asset('storage/Product_Image/'.$order->image3) }}"
                                                        data-title="Image 3">
                                                    </div>
                                                    <div class="gallery-item"
                                                        data-image="{{ asset('storage/Product_Image/'.$order->image4) }}"
                                                        data-title="Image 4">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control @error('category_id') is-invalid @enderror"
                                                name="category_id" value="{{$order->category_id}}">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control select2 @error('status') is-invalid @enderror"
                                                ...
                                                <option value="">Select Please</option>
                                                <option value="1" @if ($order->status == 1) selected @endif>Active
                                                </option>
                                                <option value="0" @if ($order->status == 0) selected @endif>Deactive
                                                </option>
                                            </select>
                                            @error('status')
                                            <div class="alert alert-danger mt-1">{{ $message }}</div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="alert alert-light mt-2 dash-border">
                                                <div class="alert-title">Selected colors for current order</div>
                                            ...
                                            <div>
                                                ...
                                                <div class="form-check form-check-inline col-md-2">
                                                    ...
                                                    <input data-id="{{ $size->id }}" type="number"
                                                        ...
                                                        {{ $size->value ? null : 'disabled' }}
                                                        onkeyup="calculateTotal('qty')" required>
                                                </div>
                                                @endforeach
                                            </div>
                                            @error('sizes')
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" id="total" type="text" name="total_qty"
