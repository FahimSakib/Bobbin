                        ...
                        <div class="card-header row">
                            <div class="col-md-10 d-flex mt-2">
                                <div class="preview d-flex">
                                    ...
                                    <div class="icon-class" style="font-size: 25px;">Index of Sliders</div>
                                </div>
                            </div>
                            <div class="pull-right">
                                <a class="btn btn-icon icon-left btn-warning"
                                    href="{{ route('admin.slider.create') }}"><i class="fas fa-plus-circle"></i>Create
                                    An slider</a>
                            </div>
                        </div>
                        <div class="card-body">
                                                ...
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item has-icon"
                                                            href="{{ route('admin.slider.show',$item->id) }}"><i
                                                                class="far fa-eye"></i> View</a>
                                                        <a class="dropdown-item has-icon"
                                                            href="{{ route('admin.slider.edit',$item->id) }}"><i
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="alert alert-info alert-has-icon col-md-8">
                                    ...
                                    <div class="alert-body">
                                        ...
                                        <h5>
                                            There is no Slider available! please create a new Slider to show in the
                                            list.
                                        </h5>
                                    </div>
                                </div>
